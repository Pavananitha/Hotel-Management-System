...
class EventBookingDetailsPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.display_event_booking_data()

    def display_event_booking_data(self):
        conn = create_connection()
        cursor = conn.cursor()

        cursor.execute("SELECT * FROM EventBookingDetailsView")
        ...
        for col in col_names:
            ...
            self.tree.column(col, width=150, anchor='w')  # Adjust width if needed
