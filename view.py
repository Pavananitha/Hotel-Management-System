...
class ViewsPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        title = tk.Label(self, text="Views Page", font=("Arial", 24, "bold"))
    ...
    def create_view_buttons(self):
        buttons = [
            ("Drivers Info", lambda: self.controller.show_frame("DriverInfoPage")),
            ("Employee Info", lambda: self.controller.show_frame("EmployeeDetailsPage")),
            ("Guest Info", lambda: self.controller.show_frame("GuestDetailsPage")),
            ("Event Booking Details", lambda:self.controller.show_frame("EventBookingDetailsPage")),
            ("Rooms Details", lambda: self.controller.show_frame("RoomDetailsPage")),
            ("Event Hall Details", lambda: self.controller.show_frame("EventHallDetailsPage")),
            ("Food Menu", lambda: self.controller.show_frame("FoodMenuDetailsPage")),
        ]
