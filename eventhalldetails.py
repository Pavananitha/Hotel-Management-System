...
class EventHallDetailsPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.display_event_hall_data()

    def display_event_hall_data(self):
        conn = create_connection()
        cursor = conn.cursor()

        cursor.execute("SELECT * FROM EventHallDetailsView")
        ...
        for col in col_names:
            ...
            self.tree.column(col, width=150, anchor='w')  # Width can be adjusted
